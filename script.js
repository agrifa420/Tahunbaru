...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('jan 1, 2026 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Hari ini, saya langitkan semua doa terbaik saya untuk kita semua.", "Semoga hal-hal yang membuat kita runtuh turut menjadi alasan  untuk tetap tumbuh.", "Semoga dunia senantiasa menjaga kita dimanapun kita berada.", "Semoga hari-hari kita selalu diiringi cinta yang tak pernah ada batasnya." , "Semoga setiap langkah kita dimudahkan hingga tercapai apa yang kita inginkan."],
  startDelay: 5000,
  speed: 50,
...
new TypeIt("#teks2", {
  strings: ["Dengan ataupun tanpa cinta, semoga semesta selalu membahagiakan kita bagimanapun caranya.", " ", ", terima kasih sudah menjadi teman sahabat dan saudara saudaraku sejauh ini.", " ", "- happy new year all"],
  startDelay: 4000,
  speed: 75,
  waitUntilVisible: true
}).go();
